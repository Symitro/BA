...
public class OeffnenUndSenden1 extends JFrame {
    ...
    void serialPortDatenVerfuegbar() throws InterruptedException {
        try {
            ...
            while (inputStream.available() > 0) {
                ...
                requestbuffer[0] = sendarraysCUM4[currentMessageCUM4][0];
                requestbuffer[1] = sendarraysCUM4[currentMessageCUM4][1];
                requestbuffer[2] = (byte) (2 * sendarraysCUM4[currentMessageCUM4][5]);
            ...
            switch (event.getEventType()) {
                case SerialPortEvent.DATA_AVAILABLE: {
                    try {
                        ...
                        Logger.getLogger(OeffnenUndSenden1.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                break;
