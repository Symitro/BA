...
public class Diagnoseapplikation extends JFrame implements TableModelListener {
    ...
    Device[] deviceArray = {
        new Device(sendarraysSH4, "100302"),
        new Device(sendarraysSH4, "110302"),
        new Device(sendarraysSH4, "120302"),
        new Device(sendarraysSH4, ""),
        new Device(sendarraysSH4, ""),
        new Device(sendarraysSH4, ""),
        new Device(sendarraysSH4, "")
    };
...
//                byte[] sendstream = sendarrays[i][0];
//                currentMessageAAW++;
//                totalMessageCount++;
...
//                    }
                    ...
                    for (int i = 0; i < deviceArray.length; i++) {
                        if (deviceArray[i].hexIdentifier.equals(byteArrayToHex.substring(0, 6))) {
